    ...
    <div class=" grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
            ...
            <input type="text" name="invoice_no" x-model="invoice_no" tabindex="1"
                value="{{ old('invoice_no', $nextInvoiceNo ?? '') }}" placeholder="Enter invoice number"
        ...
        <div>
            ...
            <input type="date" name="invoice_date" tabindex="2"
                value="{{ old('invoice_date', now()->toDateString()) }}" readonly
        ...
        <div x-data="searchableDropdown({
            apiUrl: '{{ route('dropdown.fetch', ['type' => 'suppliers']) }}',
            optionLabel: 'name',
            optionValue: 'id'
        ...
        {{-- Staff --}}
        <div x-data="searchableDropdown({
            apiUrl: '{{ route('dropdown.fetch', ['type' => 'staff']) }}',
            optionLabel: 'name',
            optionValue: 'id'
        })" x-init="init()" class="relative" @click.outside="open = false">
