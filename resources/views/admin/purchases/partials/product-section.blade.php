<div class="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4">
    <div>
        ...
        <input type="text" name="product_code" x-model="product_code" value="{{ old('product_code') }}"
    ...
    <div>
        ...
        <input type="text" name="item_code" x-model="item_code" value="{{ old('item_code') }}"
            class="input-field w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-600 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100" />
    </div>

    <div>
        <label class="text-sm font-medium">Item Name <span class="text-red-500">*</span></label>
        <input type="text" name="item_name" x-model="item_name" value="{{ old('item_name') }}"
    ...
    <div>
        ...
        <input type="number" min="1" name="quantity" x-model.number="quantity" value="{{ old('quantity', 1) }}"
            class="input-field w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-600 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100" />
    </div>
