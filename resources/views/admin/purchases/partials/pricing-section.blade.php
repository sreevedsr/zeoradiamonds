<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
    ...
    <div>
        <x-input.text
            ...
            label="Stone Amount"
            name="stone_amount"
            model="item.stone_amount"
            min="0" step="0.01"
            x-bind:class="errors.stone_amount ? 'border-red-500' : ''"
        />
    ...
    <div class="space-y-1">
        <x-input.text
            ...
            name="diamond_rate"
            model="item.diamond_rate"
            min="0" step="0.01"
            x-init="fetchDiamondRate()"
            required
            x-bind:class="errors.diamond_rate ? 'border-red-500' : ''"
        />
    ...
    <div>
        <x-input.text
            ...
            label="Making Charge"
            name="making_charge"
            model="item.making_charge"
            min="0" step="0.01"
            x-bind:class="errors.making_charge ? 'border-red-500' : ''"
        />
    ...
    <div>
        <x-input.text
            ...
            label="Card Charge"
            name="card_charge"
            model="item.card_charge"
            min="0" step="0.01"
            x-bind:class="errors.card_charge ? 'border-red-500' : ''"
        />
    ...
    <div>
        <x-input.text
            ...
            label="Other Charge"
            name="other_charge"
            model="item.other_charge"
            min="0" step="0.01"
            x-bind:class="errors.other_charge ? 'border-red-500' : ''"
        />
    ...
    <div class="col-span-full lg:col-span-2">
        <x-input.text
            type="text"
            label="Total Amount (Including Gold Rate)"
            name="total_amount"
            readonly
        ...
        <div class="space-y-1.5">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <x-input.text
                    ...
                    name="mrp_cost"
                    readonly
                    x-bind:value="formatCurrency(item.mrp_cost || 0)"
                    class="flex-1 bg-gray-50 dark:bg-gray-800
                           font-medium text-gray-800 dark:text-gray-100"
                />
            </div>
