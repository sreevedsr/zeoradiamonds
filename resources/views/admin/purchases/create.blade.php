        ...
        <div x-data="{ showModal: false }" @close-purchase-modal.window="showModal = false">
            <div>
                <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data"
                    x-init="enableSequentialInput($el, '#add-item-btn');
                    focusFirstInput();" novalidate>
                    @csrf
                    {{-- Purchase Header --}}
            ...
            <div x-show="showModal" x-transition.opacity.duration.250ms
                ...
                <div x-transition:enter="ease-out duration-300"
                    ...
                    role="dialog" aria-modal="true" aria-labelledby="modal-title" x-data="purchaseForm(gold_rate, diamond_rate)">
                    <!-- Sticky Header -->
                    <div
                    ...
                    <div class="flex-1 overflow-y-auto px-6 py-8 custom-scrollbar">
                        <div x-ref="itemForm" class="space-y-12">
                            {{-- Product Info --}}
                            <section>
