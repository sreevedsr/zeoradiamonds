<x-app-layout>
    ...
    <form method="POST" action="{{ route('admin.products.assign') }}" enctype="multipart/form-data" x-data="purchaseForm()"
        ...
        <div class="space-y-8">
           ...
           text-gray-900 dark:text-gray-100 shadow-sm dark:shadow-md dark:shadow-gray-900/50">
                ...
                <div x-data="searchableDropdown({
                    ...
                    optionLabel: 'name',
                    optionValue: 'id'
                })" x-init="init()" class="relative mt-8"
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-4 border-b border-gray-200 dark:border-gray-700 pb-3">
                    ...
                    <button type="button" id="add-sale-item-btn" tabindex="5" @click="$store.saleModal.open()"
