...
<div class="relative" x-data="{
    ...
    <div class="relative">
        <input type="text" placeholder="Search or select {{ strtolower($label) }}" x-model="searchQuery"
    ...
    <input type="hidden" :name="'{{ $name }}'" x-model="selectedCode" required>
</div>
