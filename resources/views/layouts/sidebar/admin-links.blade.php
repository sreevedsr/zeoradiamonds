...
@can('manage-reports')
    <li class="relative px-6 py-3" x-data="collapsibleMenu({{ request()->routeIs('admin.reports.*') ? true : false }})">
        ...
        <ul x-ref="panel" :style="`height: ${height}px`" @transitionend="if (open) height = 'auto'"
            ...
            <li>
                <a href="{{ route('admin.reports.purchase') }}"
                    class="{{ request()->routeIs('admin.reports.purchase')
                        ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700'
                        : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }}
                    block rounded-md px-2 py-1 text-sm font-medium">
                    Purchase Report
            ...
            <li>
                <a href="{{ route('admin.reports.sales') }}"
                    class="{{ request()->routeIs('admin.reports.sales')
                        ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700'
                        : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }}
                    block rounded-md px-2 py-1 text-sm font-medium">
                    Sales Report
