...
<div class="hidden w-64 flex-shrink-0 overflow-y-auto bg-white dark:bg-gray-800 md:block">
    <div class="flex h-full flex-col justify-between bg-white py-4 text-gray-500 dark:bg-gray-800 dark:text-gray-400">
        ...
        "
                            ...
                            <span
                                class="{{ request()->routeIs('admin.merchants.*')
                                    ...
                                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} ml-2 flex-1 text-left">Merchants</span>
                            <svg class="ml-auto h-4 w-4 rotate-0 transform-gpu transition-transform duration-300 ease-in-out"
        ...
        "
                            ...
                            <li>
                                <a href="{{ route('admin.merchants.create') }}"
                                    class="{{ request()->routeIs('admin.merchants.create') ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} block rounded-md px-2 py-1 text-sm font-medium">
                                    Add Merchant
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.merchants.index') }}"
                                    class="{{ request()->routeIs('admin.merchants.index') ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} block rounded-md px-2 py-1 text-sm font-medium">
                                    View Merchants
                                </a>
                            </li>
                        </ul>
            ...
            "
                            ...
                            <span
                                class="{{ request()->routeIs('merchant.customers.*')
                                    ? 'text-gray-800 dark:text-gray-200'
                                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} ml-2 flex-1 text-left">Customers</span>
            ...
            "
                            ...
                            <span
                                class="{{ request()->routeIs('admin.cards.*')
                                    ? 'text-gray-800 dark:text-gray-200'
                        ...
                        <ul x-ref="cardsPanel" :style="`height: ${height}px`"
                            ...
                            <li>
                                <a href="{{ route('admin.cards.create') }}"
                                    class="{{ request()->routeIs('admin.cards.create') ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} block rounded-md px-2 py-1 text-sm font-medium">
                                    Add Card
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('admin.cards.index') }}"
                                    class="{{ request()->routeIs('admin.cards.index') ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} block rounded-md px-2 py-1 text-sm font-medium">
                                    View Cards
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.cards.assign') }}"
                                    class="{{ request()->routeIs('admin.cards.assign')
                                        ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700'
                                        : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} block rounded-md px-2 py-1 text-sm font-medium">
                                    Assign Cards
                                </a>
                            ...
                            <li>
                                <a href="{{ route('admin.cards.requests') }}"
                                    class="{{ request()->routeIs('admin.cards.requests') ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} block rounded-md px-2 py-1 text-sm font-medium">
                                    View Card Requests
                                </a>
                            </li>
                        </ul>
...
<!-- Mobile Sidebar -->
{{-- <div x-show="isSideMenuOpen" x-transition.opacity class="fixed inset-0 z-10 bg-black bg-opacity-50 md:hidden"> --}}
...
<div class="fixed inset-y-0 z-20 mt-16 flex h-full w-64 flex-col justify-between overflow-y-auto bg-white py-4 text-gray-500 dark:bg-gray-800 dark:text-gray-400 md:hidden"
    ...
    <div>
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                <a href="{{ route('dashboard') }}"
                    class="{{ request()->routeIs('dashboard') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} inline-flex w-full items-center text-sm font-semibold transition-colors duration-150">
                    Dashboard
                </a>
            </li>
        </ul>
        ...
        <!-- Merchants -->
        <li class="relative px-6 py-3" x-data="{ openMerchants: {{ request()->routeIs('merchant.*') ? 'true' : 'false' }} }">
            <button @click="openMerchants = !openMerchants"
                class="{{ request()->routeIs('merchant.*') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} inline-flex w-full items-center justify-between text-sm font-semibold transition-colors duration-150">
                <span>Merchants</span>
            ...
            <ul x-show="openMerchants" x-transition class="mt-2 space-y-2 pl-4">
                <li>
                    <a href="{{ route('admin.merchants.index') }}"
                        class="{{ request()->routeIs('admin.merchants.index') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 hover:text-gray-800 dark:hover:text-gray-200' }} block text-sm font-medium">
                        All Merchants
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.merchants.create') }}"
                        class="{{ request()->routeIs('admin.merchants.create') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 hover:text-gray-800 dark:hover:text-gray-200' }} block text-sm font-medium">
                        Add Merchant
                    </a>
                </li>
            </ul>
        ...
        <!-- Customers -->
        <li class="relative px-6 py-3" x-data="{ openCustomers: {{ request()->routeIs('customer.*') ? 'true' : 'false' }} }">
            <button @click="openCustomers = !openCustomers"
                class="{{ request()->routeIs('customer.*') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} inline-flex w-full items-center justify-between text-sm font-semibold transition-colors duration-150">
                <span>Customers</span>
                <svg class="ml-2 h-4 w-4 transform transition-transform duration-300"
                    :class="{ 'rotate-180': openCustomers }" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
            ...
            <ul x-show="openCustomers" x-transition class="mt-2 space-y-2 pl-4">
                <li>
                    <a href="{{ route('merchant.customers.index') }}"
                        class="{{ request()->routeIs('merchant.customers.index') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 hover:text-gray-800 dark:hover:text-gray-200' }} block text-sm font-medium">
                        All Customers
                    </a>
                </li>
                <li>
                    <a href="{{ route('merchant.customers.create') }}"
                        class="{{ request()->routeIs('merchant.customers.create') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 hover:text-gray-800 dark:hover:text-gray-200' }} block text-sm font-medium">
                        Add Customer
                    </a>
                </li>
            </ul>
        ...
        @can('view-cards')
            <li class="relative px-6 py-3">
                <a href="{{ route('admin.cards.index') }}"
                    class="{{ request()->routeIs('cards.*') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }} inline-flex w-full items-center text-sm font-semibold transition-colors duration-150">
                    Cards
                </a>
            </li>
        @endcan
