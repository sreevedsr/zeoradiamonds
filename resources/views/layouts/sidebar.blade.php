                        ...
                        <ul x-ref="panel" :style="`height: ${height}px`"
                            ...
                            <li>
                                <a href="{{ route('merchant.customers.create') }}"
                                    class="block px-2 py-1 text-sm font-medium rounded-md
                        {{ request()->routeIs('merchant.customers.create')
                            ...
                            <li>
                                <a href="{{ route('merchant.customers.index') }}"
                                    class="block px-2 py-1 text-sm font-medium rounded-md
                        {{ request()->routeIs('merchant.customers.index')
                            ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700'
                            : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }}">
                                    View Customers
                                </a>
                    ...
                    {{ request()->routeIs('admin.cards.index') ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }}">
                            ...
                            <li>
                                <a href="{{ route('admin.cards.assign') }}"
                                    class="block px-2 py-1 text-sm font-medium rounded-md
                    {{ request()->routeIs('admin.cards.assign')
                        ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700'
                        : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }}">
                                    Assign Cards
                                </a>
            ...
            --}}
                            ...
                            <li>
                                <a href="{{ route('merchant.marketplace.request') }}"
                                    class="block px-2 py-1 text-sm font-medium rounded-md
                    {{ request()->routeIs('merchant.marketplace.request')
                        ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700'
                        : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }}">
                                    Request Cards
                                </a>
                            ...
                            <li>
                                <a href="{{ route('merchant.marketplace.view') }}"
                                    class="block px-2 py-1 text-sm font-medium rounded-md
                    {{ request()->routeIs('merchant.marketplace.view')
                        ? 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700'
                        : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }}">
                                    View Requests
                                </a>
        ...
        <div class="fixed inset-y-0 z-20 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden flex flex-col justify-between py-4 text-gray-500 dark:text-gray-400 h-full"
            ...
            <div>
                ...
                <li class="relative px-6 py-3" x-data="{ openMerchants: {{ request()->routeIs('merchant.*') ? 'true' : 'false' }} }">
                    ...
                    {{ request()->routeIs('merchant.*') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }}">
                        <span>Merchants</span>
                    ...
                    <ul x-show="openMerchants" x-transition class="mt-2 space-y-2 pl-4">
                        <li>
                            ...
                            {{ request()->routeIs('admin.merchants.index') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 hover:text-gray-800 dark:hover:text-gray-200' }}">
                                All Merchants
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.merchants.create') }}"
                                class="block text-sm font-medium
                            {{ request()->routeIs('admin.merchants.create') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 hover:text-gray-800 dark:hover:text-gray-200' }}">
                                Add Merchant
                            </a>
                        </li>
                    </ul>
                ...
                <li class="relative px-6 py-3" x-data="{ openCustomers: {{ request()->routeIs('customer.*') ? 'true' : 'false' }} }">
                    <button @click="openCustomers = !openCustomers"
                        class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150
                    {{ request()->routeIs('customer.*') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }}">
                        <span>Customers</span>
                        <svg class="w-4 h-4 ml-2 transform transition-transform duration-300"
                            :class="{ 'rotate-180': openCustomers }" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                    ...
                    <ul x-show="openCustomers" x-transition class="mt-2 space-y-2 pl-4">
                        <li>
                            <a href="{{ route('merchant.customers.index') }}"
                                class="block text-sm font-medium
                            {{ request()->routeIs('merchant.customers.index') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 hover:text-gray-800 dark:hover:text-gray-200' }}">
                                All Customers
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('merchant.customers.create') }}"
                                class="block text-sm font-medium
                            {{ request()->routeIs('merchant.customers.create') ? 'text-gray-800 dark:text-gray-200' : 'text-gray-500 hover:text-gray-800 dark:hover:text-gray-200' }}">
                                Add Customer
                            </a>
                        </li>
                    </ul>
