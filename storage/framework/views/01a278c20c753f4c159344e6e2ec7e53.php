...
<?php $component->withAttributes(['name' => 'confirm-delete-modal','focusable' => true]); ?>
    <form method="POST" action="<?php echo e($action); ?>" id="deleteForm" class="p-6">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Zeeyame\resources\views/components/confirm-delete-modal.blade.php ENDPATH**/ ?>