    ...
    <div x-data="pageTransition()" class="relative flex h-screen items-center justify-center overflow-hidden bg-gray-900">
        ...
        <template x-if="loaded">
            <img :src="document.documentElement.classList.contains('dark') ?
                '<?php echo e(asset('assets/img/login-office-dark.jpeg')); ?>' :
                '<?php echo e(asset('assets/img/login.jpeg')); ?>'"
                class="absolute inset-0 h-full w-full object-cover transition-transform duration-[2000ms] ease-out"
                alt="Office" />
        </template>

        <!-- Gradient Overlay -->
        <div x-show="loaded" x-transition:enter="transition-opacity ease-in-out duration-700 delay-100"
        ...
        <!-- Login Card -->
        <div x-show="show" x-transition:enter="transition-all ease-out duration-600 delay-150"
            ...
            <div class="relative z-10">
                <div x-show="show" x-transition:enter="transition-all duration-1000 ease-out delay-200"
                    x-transition:enter-start="opacity-0 translate-y-2"
                    x-transition:enter-end="opacity-100 translate-y-0" class="mb-8 text-center">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                    ...
                    <!-- Email -->
                    <div x-show="show" x-transition:enter="transition-all duration-700 ease-out delay-400"
                        x-transition:enter-start="opacity-0 translate-y-2"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- Password -->
                    <div x-data="{ showPassword: false }" x-show="show"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- Submit Button -->
                    <div x-show="show" x-transition:enter="transition-all duration-700 ease-out delay-600"
                        x-transition:enter-start="opacity-0 translate-y-2"
                        x-transition:enter-end="opacity-100 translate-y-0">
                        <button type="submit"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\zeoradiamonds\resources\views/auth/login.blade.php ENDPATH**/ ?>