...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['type' => 'button','xData' => true,'xOn:click.prevent' => '
                                        ...
                                        setTimeout(() => {
                                            document.getElementById(\'edit_staff_code\').value = \''.e($s->code).'\';
                                            document.getElementById(\'edit_name\').value = \''.e($s->name).'\';
                                            document.getElementById(\'edit_phone_no\').value = \''.e($s->phone_no).'\';
                                            document.getElementById(\'edit_address\').value = \''.e($s->address).'\';
                                            document.getElementById(\'editStaffForm\').action = \''.e(route('admin.staff.update', $s->id)).'\';
                                        }, 100);
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button','data' => ['type' => 'button','xData' => true,'xOn:click.prevent' => '
                                        ...
                                        document.getElementById(\'deleteForm\').action = \''.e(route('admin.staff.destroy', $s->id)).'\';
                                    ']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['name' => 'edit-staff-modal','focusable' => true]); ?>
                <form method="POST" id="editStaffForm" class="p-6">
                    ...
                    <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                        <?php echo e(__('Edit Staff Details')); ?>

                    </h2>

                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        <?php echo e(__('Update staff details below and click "Save Changes".')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'edit_staff_code','value' => ''.e(__('Staff Code')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'edit_staff_code','value' => ''.e(__('Staff Code')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'edit_staff_code','name' => 'code','type' => 'text','class' => 'mt-1 block w-full','placeholder' => ''.e(__('Enter staff code')).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'edit_staff_code','name' => 'code','type' => 'text','class' => 'mt-1 block w-full','placeholder' => ''.e(__('Enter staff code')).'','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'edit_name','name' => 'name','type' => 'text','class' => 'mt-1 block w-full','placeholder' => ''.e(__('Enter name')).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'edit_name','name' => 'name','type' => 'text','class' => 'mt-1 block w-full','placeholder' => ''.e(__('Enter name')).'','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'edit_phone_no','name' => 'phone_no','type' => 'text','class' => 'mt-1 block w-full','placeholder' => ''.e(__('Enter phone number')).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'edit_phone_no','name' => 'phone_no','type' => 'text','class' => 'mt-1 block w-full','placeholder' => ''.e(__('Enter phone number')).'','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.textarea','data' => ['id' => 'edit_address','name' => 'address','rows' => '2','class' => 'mt-1 block w-full','placeholder' => ''.e(__('Enter address')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'edit_address','name' => 'address','rows' => '2','class' => 'mt-1 block w-full','placeholder' => ''.e(__('Enter address')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = App\View\Components\ConfirmDeleteModal::resolve(['action' => '#','title' => 'Confirm Deletion','message' => 'Are you sure you want to delete this staff record? This action cannot be undone.'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
