<div
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
            ...
            <input type="text" name="invoice_no" tabindex="1" required value="<?php echo e(old('invoice_no')); ?>"
...
<?php /**PATH C:\xampp\htdocs\zeoradiamonds\resources\views/admin/purchases/partials/header-section.blade.php ENDPATH**/ ?>