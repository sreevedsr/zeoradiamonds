...
<?php $component->withAttributes([]); ?>
    <?php $__env->slot('title', 'Zeeyame - Add Diamond Rate'); ?>
    ...
    <div class="mx-auto">
        <div class="p-6 sm:p-8 bg-white dark:bg-gray-800 shadow-md rounded-lg">
            ...
            <form action="<?php echo e(route('admin.goldrates.storeDiamond')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="diamond_type" value="<?php echo e(old('diamond_type')); ?>" required
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Zeeyame\resources\views/admin/goldrates/diamond.blade.php ENDPATH**/ ?>