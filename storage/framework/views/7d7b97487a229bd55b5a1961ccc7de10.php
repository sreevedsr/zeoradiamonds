                            ...
                            <tr class="text-gray-700 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <div class="flex items-center space-x-2">
                                        <a href="<?php echo e(route('merchants.show', $merchant->id)); ?>" class="text-blue-600 hover:underline">View</a>
                                        <a href="<?php echo e(route('merchants.edit', $merchant->id)); ?>" class="text-yellow-600 hover:underline">Edit</a>
                                        <form action="<?php echo e(route('merchants.destroy', $merchant->id)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
