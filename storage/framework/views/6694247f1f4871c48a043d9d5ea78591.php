...
>
    ...
    >
        <div class="absolute inset-0 bg-gray-900 bg-opacity-70 dark:bg-gray-900 dark:bg-opacity-80"></div>
    </div>

    <!-- Centered Modal Content -->
    <div
        x-show="show"
        class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden transform transition-all sm:mx-auto "
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH C:\xampp\htdocs\zeoradiamonds\resources\views/components/modal.blade.php ENDPATH**/ ?>