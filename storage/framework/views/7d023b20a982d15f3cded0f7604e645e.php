<ul class="mt-6">
    ...
    <?php if($user && $user->role === 'admin'): ?>
        ...
        <?php echo $__env->make('layouts.sidebar.admin-links', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php elseif($user && $user->role === 'merchant'): ?>
        
        <?php echo $__env->make('layouts.sidebar.merchant-links', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
