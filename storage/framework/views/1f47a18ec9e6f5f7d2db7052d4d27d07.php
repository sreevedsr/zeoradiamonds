...
<?php $component->withAttributes([]); ?>
    <?php $__env->slot('title', 'Zeeyame - Suppliers'); ?>
...
<?php endif; ?>
                                ...
                                <!-- Delete Button -->
                                <form action="<?php echo e(route('admin.suppliers.destroy', $supplier->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'edit-supplier-modal','focusable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['name' => 'confirm-delete-modal','focusable' => true]); ?>
                <form method="POST" id="deleteSupplierForm" class="p-6">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        <?php echo e(__('Are you sure you want to delete this supplier? This action cannot be undone.')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Zeeyame\resources\views/admin/suppliers/index.blade.php ENDPATH**/ ?>