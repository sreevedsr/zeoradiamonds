...
<div x-data="{ show: true }" x-show="show" x-transition:enter="transition ease-out duration-500"
    ...
    x-transition:enter-end="translate-x-0 opacity-100 scale-100" x-transition:leave="transition ease-in duration-400"
    x-transition:leave-start="translate-x-0 opacity-100" x-transition:leave-end="translate-x-full opacity-0 scale-95"
    x-init="setTimeout(() => show = false, 5000)"
    class="fixed top-8 right-8 z-[9999] flex items-center gap-3 px-8 py-5 rounded-lg shadow-xl transition-all duration-500 transform
        <?php if($type === 'success'): ?>
...
<?php /**PATH C:\xampp\htdocs\Zeeyame\resources\views/components/alert-toast.blade.php ENDPATH**/ ?>